...
| M06 | The Lovers | claude (build placeholder) | — | 1 | placeholder |
| M07 | The Chariot | claude (build placeholder) | — | 1 | placeholder |
| M08 | Strength | claude (build placeholder) | — | 1 | placeholder |
| M09 | The Hermit | claude (build placeholder + calibration draft ×2/field) | — | 2 | drafted (in /drafts; meanings.json still placeholder) |
| M10 | The Wheel of Fortune | claude (build placeholder) | — | 1 | placeholder |
| M11 | Justice | claude (build placeholder) | — | 1 | placeholder |
| M12 | The Hanged Man | claude (build placeholder) | — | 1 | placeholder |
| M13 | Death | claude (build placeholder) | — | 1 | placeholder |
| M14 | Temperance | claude (build placeholder) | — | 1 | placeholder |
| M15 | The Devil | claude (build placeholder) | — | 1 | placeholder |
| M16 | The Tower | claude (build placeholder + calibration draft ×2/field) | — | 2 | drafted (in /drafts; meanings.json still placeholder) |
| M17 | The Star | claude (build placeholder) | — | 1 | placeholder |
| M18 | The Moon | claude (build placeholder) | — | 1 | placeholder |
...
| wands-page | Page of Hawthorn | claude (build placeholder + batch 4 draft + clipping pass) | pending | 2 | drafted |
| wands-knight | Knight of Hawthorn | claude (build placeholder + batch 4 draft + clipping pass) | pending | 2 | drafted |
...
| cups-page | Page of Bellflower | claude (build placeholder + batch 4 draft + clipping pass) | pending | 2 | drafted |
| cups-knight | Knight of Bellflower | claude (build placeholder + batch 4 draft + clipping pass) | pending | 2 | drafted |
...
| swords-page | Page of Gladiolus | claude (build placeholder + batch 4 draft + clipping pass) | pending | 2 | drafted |
| swords-knight | Knight of Gladiolus | claude (build placeholder + batch 4 draft + clipping pass) | pending | 2 | drafted |
...
| pentacles-page | Page of Lunaria | claude (build placeholder + batch 4 draft + clipping pass) | pending | 2 | drafted |
| pentacles-knight | Knight of Lunaria | claude (build placeholder + batch 4 draft + clipping pass) | pending | 2 | drafted |
| pentacles-queen | Queen of Lunaria | claude (build placeholder) | — | 1 | placeholder |
| pentacles-king | King of Lunaria | claude (build placeholder) | — | 1 | placeholder |

## Rounds

- **2026-07-29, batch 1.** Drafted by Claude, 13 cards at variant depth.
  Editorial revision pass drafted by Claude against author review notes.
  Author accepted all 13 and approved the pass. Status `authored`. Final
  requires the end-state checks, which need all 78 cards to exist.
- **2026-07-29, batch 2.** Drafted by Claude, 13 cards. Self-review
  gauntlet and a drift-triggered clipping pass applied before review.
  Awaiting author accept, edit, or recast.
- Author decisions recorded so far: voice chosen at the Gate 1 bake-off,
...
- **2026-07-29, batch 4.** Drafted by Claude, 8 cards, the four Pages and
  the four Knights. Author accepted batch 3 entire. Self-review gauntlet
  and a fourteen-sentence clipping pass applied before review. Corpus at
  48 of 78. Awaiting accept, edit, or recast on batch 4.
